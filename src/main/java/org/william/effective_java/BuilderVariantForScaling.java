...
public class BuilderVariantForScaling {
	public static void main(String[] args) {
		NutritionFacts facts = new NutritionFacts.Builder(20, 5).fat(3).build();
	}
	...
	public static class NutritionFacts {
		...
		/**
		 * enforces immutability pass in builder for convenience
		 * 
		 * @param builder
		 */
